...
<body id="main_body" >
		...
		<div class="panel panel-primary">
			...
			<form class="form-incline" class="A21"  method="" action="get">
			...
			<div class="panel-heading">
				...
				<h3>Datos del acta</h3>
					...
					<div class="row">
						...
						<div class="col-xs-2">
							<input type="text" name= "hora" class="form-control" placeholder="hora" value="<?php echo $hora; ?>" readonly/>
						</div>
		...
		<div class="panel panel-success">
			<div class="panel-heading">
				...
				<label>
					<input type="radio" name="opciones" id="opciones_1"value="opcion_1" checked>Corpulenta</label>
				<label>
					<input type="radio" name="opciones" id="opciones_1"value="opcion_1" checked>Mediana</label>
				<label>
					<input type="radio" name="opciones" id="opciones_1"value="opcion_1" checked>Pequeña</label>
				<hr />
				</div>
		...
		<div class="panel panel-success">
			<div class="panel-heading">
				...
				<div class="Comportamiento">
					...
					<label for="fisica"><h4 style="margin-top: -5px;">Comportamiento&nbsp</h4></label>
					</br>
			</div>
		</div>
	...
	<div class="panel panel-success">
		<div class="panel-heading">
			<div class="Descripcion_Motricidad">
				...
				<textarea rows="4" cols="185"></textarea>
	</div>
