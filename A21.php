	...
	<img id="logo" src="img/Ajun.jpg" width="60px" height="50px" alt="">
		...
		<form id="A21" class="A21"  method="" action="" onsubmit="return validaFormulario();">
			...
			<div class="Descripcion_conduccion">
				<label class="Descripcion" for=""><h3>Descripcion de la conduccion</h3></label><hr />
			...
			<div class="simptoma">
				...
				<label for="simptoma"><h3>Simptomatologia</h3></label></br>
				<hr style="margin-top: -30px;" />
				<label for="persona"><h3>Es fa constar que la persona requerida presentava la simptomatologia siguiente:
			    </h3></label><hr style="margin-top: -10px;" />

			</div>

		<div class="Halitosi">
			
			<label for="olor"><h4>Habilitosi de alcohol</h4></label></br>
			<input id="Halitosi" name="olor" class="olor" maxlength="5" value="" type="checkbox">
			<label for="Habilitosi">El olor que desprende es claramente detectable</label></br><hr />
		</div>

		<div class="Fisica">
			
			<label for="fisica"><h4>Constitución física</h4></label></br>
		...
		<div class="Comportamiento">
			...
			<label for="comporta"><h4>Comportamiento</h4></label></br>
