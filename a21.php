	...
	<div class="panel panel-primary" style="border: 8px solid transparent; border-color: #337ab7; background-color:#F5F6CE";>
			<div class="panel-heading">
				<img id="logo" src="img/placaPecho1.jpg" alt="">
					...
					<form class="form-incline" class="A21"  method="" action="a21.proc.php" onsubmit="return validaFormulario();">
			...
			<div class="panel-heading">
				...
				<div class="row">
					...
					<div class="col-xs-2">		
						...
						<!-- <div class="col-xs-2">		
						<input type="text" name= "agente2" id="agente2" class="form-control" placeholder="Agente2" value="<?php echo $tip; ?>" readonly/>
						</div> -->
			...
			<h3 style="margin-top: -5px;"> Acta de simptomatologia: Datos de la persona requerida </h3>
				...
				<div class="row">
					...
					<div class="col-xs-2"
						...
						<label class="sr-only" for="apellidos"></label>
						<input type="text" id="apellidos2" name= "apellidos2" class="form-control" placeholder="Sedundo Apellido" value="<?php echo $dni['Segundoapellido']; ?>" readonly/>
